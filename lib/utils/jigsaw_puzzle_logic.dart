...
class JigsawPuzzleLogic extends StatefulWidget {
  const JigsawPuzzleLogic({
    Key? key,
  ...
  @override
  _JigsawPuzzleLogicState createState() => _JigsawPuzzleLogicState();
}

class _JigsawPuzzleLogicState extends State<JigsawPuzzleLogic> {
  @override
